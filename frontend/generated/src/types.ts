...
export type LoginQuery = (
  ...
  & { Login: (
    { __typename?: 'Authentication' }
    & Pick<Authentication, 'accessToken' | 'refreshToken'>
  ) }
);
...
export type UserInfoFragment = (
  { __typename?: 'UserSafe' }
  & Pick<UserSafe, '_id' | 'name' | 'avatar' | 'status' | 'isClosed' | 'isOnlineMobile' | 'dateLastOnline'>
);
