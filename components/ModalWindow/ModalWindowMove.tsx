import { ReactElement, CSSProperties, useState, useRef, MouseEvent } from "react"
...
const ModalWindowMove = ({ children, style, className, visible = true }: Props): ReactElement => {
    ...
    const onMouseMove = (e: MouseEvent) => {
        ...
        const { clientHeight: heightTotal, clientWidth: widthTotal } = totalRef.current
    ...
    return visible ?
        <div ref={totalRef} className='total'
            ...
            <div ref={modalRef} style={style} className={`${modalwindow} ${className ?? ''}`} >
