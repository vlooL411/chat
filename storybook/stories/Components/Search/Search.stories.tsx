...
const RandDate = (): Date => new Date((new Date().getTime() - (Math.random() * 10000)))
const DateAdd = (date: Date, minute: number): string => new Date(date.getTime() + minute * 1000 * 60).toDateString()
